...
import (
	...
	models "github.com/harshalranjhani/gofibre/model"
	responses "github.com/harshalranjhani/gofibre/responses"
...
func CreateUser(c *fiber.Ctx) error {
	...
	// using the validator library to validate the required fields
